...
export function UpdateProductForm({ product }: { product: Product }) {
  ...
  const form = useForm<productPayload>({
    ...
    defaultValues: {
      ...
      images: product.images as productPayload['images'],
    },
  })

  const onSubmit: SubmitHandler<productPayload> = async (values) => {
    try {
      setIsLoading(true)
      await axios.patch(
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <Button isLoading={isLoading}>Update Product</Button>
      </form>
    </Form>
  )
}
